...
class Test4LeftRingView extends FlatSpec with ShouldMatchers {
  ...
  it should "list elements in same order as parent" in {
    val s = new LeftRing[Int](5); s ++= Array(1,2,3,4,5)
    val v = s.view(3)
